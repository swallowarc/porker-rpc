...
func (m *MockMemDBClient) PublishStream(ctx context.Context, streamKey string, messages map[string]interface{}) error {
	m.ctrl.T.Helper()
...
func (mr *MockMemDBClientMockRecorder) PublishStream(ctx, streamKey, messages interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMemDBClientMockRecorder) ReadStream(ctx, streamKey, messageKey, previousID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMemDBClientMockRecorder) ReadStreamLatest(ctx, streamKey, messageKey interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockMemDBClient) SAdd(ctx context.Context, key string, values ...interface{}) error {
	m.ctrl.T.Helper()
...
func (mr *MockMemDBClientMockRecorder) SAdd(ctx, key interface{}, values ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMemDBClientMockRecorder) SMembers(ctx, key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SMembers", reflect.TypeOf((*MockMemDBClient)(nil).SMembers), ctx, key)
}

// SRem mocks base method.
func (m *MockMemDBClient) SRem(ctx context.Context, key string, members ...interface{}) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, key}
...
func (mr *MockMemDBClientMockRecorder) SRem(ctx, key interface{}, members ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockMemDBClient) Set(ctx context.Context, key string, value interface{}, duration time.Duration) error {
	m.ctrl.T.Helper()
...
func (m *MockMemDBClient) SetNX(ctx context.Context, key string, value interface{}, duration time.Duration) error {
	m.ctrl.T.Helper()
